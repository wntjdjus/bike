...
<body>
  <?
      ...
      $connect=dbconn();
  ?>
  <form action='./endshare_post.php' name='review_table' method='post'>
<br>
<br>
<CENTER>자전거 공유</b></div><br>
<form action="" method="post">
<label>아 이 디 : </label><input type="text" name="bikeid" class="box"/><br>
<label>대 여 존 : </label><input type="text" name="zoneid" class="box"/></br>
<label>거 치 대 : </label><input type="text" name="holderid" class="box"/></br>
<label>공유시간 : </label>
...
<?php
          ...
          $query="SELECT * FROM share as s, bike as b where s.bikeid = b.bikeid and b.ownerid = $userid";
